 ...
 */
layui.define(["jquery", "miniMenu", "element", "miniTab", "miniTheme", "nixue"], function (exports) {
    var $ = layui.$,
        layer = layui.layer,
    ...
    var miniAdmin = {
        ...
        render: function (options) {
            ...
            nx.Psot(function (data) {
                if (data.code != 0) {
                    ...
                    data = miniAdmin.MenusInfo = data.data;
        ...
        listen: function () {
            ...
            $('body').on('click', '.login-out', function () {
                nx.confirm("您确认退出登录吗？", function () {
                    nx.Psot(function (data) {
                        window.onbeforeunload = null;
                        layer.msg(data.msg, function () {
                            window.location = data.data.Url;
                        });
                    }, "../../Api/AdminServers/Logout");
                })
            });
            ...
            $(".user-id").text(miniAdmin.MenusInfo.userInfo.name);
